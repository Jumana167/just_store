  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(l10n.electronics, style: const TextStyle(color: AppTheme.white)),
        centerTitle: true,
                  ...
                  if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                    return Center(
                      child: Column(
                        ...
                        children: [
                          Icon(Icons.devices, size: 64, color: AppTheme.mediumGrey),
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => ElectronicsDetailsPage(
                                image: data['imageUrl'] ?? '',
                                title: data['name'] ?? '',
